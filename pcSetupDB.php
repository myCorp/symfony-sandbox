...
mysqli_query($db_server, "CREATE TABLE client (clientID INT UNIQUE AUTO_INCREMENT PRIMARY KEY, firstName VARCHAR(16), 
	lastName VARCHAR(16), address VARCHAR(64), phone VARCHAR(16), mail VARCHAR(32))");
mysqli_query($db_server, "ALTER TABLE client ADD INDEX(clientID)");
...
mysqli_query($db_server, "CREATE TABLE pet (id INT UNIQUE NOT NULL AUTO_INCREMENT KEY, clientID INT NOT NULL, nickname VARCHAR(16), breed VARCHAR(16), 
	age INT)");
mysqli_query($db_server, "ALTER TABLE pet ADD INDEX(clientID)");
...
mysqli_query($db_server, "ALTER TABLE veterinarian ADD INDEX(clientID)");
...
mysqli_query($db_server, "CREATE TABLE reception (id INT UNIQUE NOT NULL AUTO_INCREMENT KEY, clientID INT NOT NULL, date VARCHAR(16) NOT NULL, start_time_reception VARCHAR(16), 
	...
	status TINYINT)");
mysqli_query($db_server, "ALTER TABLE reception ADD INDEX(clientID)");
